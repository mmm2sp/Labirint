...
class Key:
    ...
    def draw(self):
        ...
        pygame.draw.circle(self.screen, (210, 210, 0), (self.x,self.y+self.l//5), self.l*2//9)
...
class Opened_door:
    ...
    def draw(self):
        ...
        pygame.draw.polygon(self.screen, (155, 0, 0), [(self.x+l, self.y),(self.x+self.l//10, self.y+self.l//3),(self.x+self.l//10, self.y+self.l*2.33),(self.x+self.l, self.y+2*self.l)])
...
#class Closed_door:
    '''
    Рисует закрытую дверь для кат сцены
    '''
