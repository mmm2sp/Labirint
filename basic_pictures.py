...
class Minotaur:
    ...
    def draw(self):
        ...
        pygame.draw.polygon(self.screen, (120, 50, 0),
                            [(self.x, self.y + 8), (self.x - 6, self.y - 7), (self.x + 6, self.y - 7)])
        pygame.draw.polygon(self.screen, (0, 0, 0),
                            [(self.x - 5, self.y - 7), (self.x - 4, self.y - 9), (self.x - 4, self.y - 7)])
        pygame.draw.polygon(self.screen, (0, 0, 0),
                            [(self.x + 5, self.y - 7), (self.x + 4, self.y - 9), (self.x + 4, self.y - 7)])
...
class Armory:
    ...
    def draw(self):
        ...
        pygame.draw.polygon(self.screen, (160, 160, 160),
                            [(self.x - 6, self.y + 8), (self.x - 8, self.y + 6), (self.x + 8, self.y - 8)])
